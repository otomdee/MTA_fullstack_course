...
#scoring on r_dict based on X or O in x_dict(on the board)
def scoring():    
    for i in x_dict:
        if x_dict[i] == "X":
...
#loop to allow multiple turns and restart the game after a win
def game():
    print_board()
